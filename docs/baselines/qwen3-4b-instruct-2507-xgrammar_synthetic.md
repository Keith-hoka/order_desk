# Eval report — qwen3-4b-instruct-2507-xgrammar on synthetic
...
- headline: P 0.7133 / R 0.7203 / F1 0.7168 [0.7053, 0.7274]
- strict_rate: 0.9998   hallucination_rate: 0.1188
...
| delivery_address_text | 0.7275 | 0.7467 | 0.7370 | 0.0404 | 0.8588 | 1.0000 |
...
| unit_text | 0.8079 | 0.8842 | 0.8444 | 0.5687 | 0.7741 | 0.9991 |
...
|---|---|---|---|---|---|
| class:new_order | 700 | 0.9757 | 700 | 0.7140 | 0.2319 |
...
| flag:ambiguous_site | 82 | 0.9878 | 82 | 0.6954 | 0.2264 |
...
| flag:mention_typo | 48 | 0.9792 | 48 | 0.6995 | 0.2182 |
...
| route:touchless | 365 | 0.9863 | 365 | 0.7375 | 0.2776 |
| route:clarification | 92 | 0.9565 | 92 | 0.6710 | 0.2308 |
| route:exception | 243 | 0.9671 | 243 | 0.6949 | 0.1733 |
| layout:dash_list | 271 | 0.9668 | 271 | 0.6647 | 0.0693 |
| layout:x_list | 154 | 0.9805 | 154 | 0.6752 | 0.1027 |
| layout:reverse_list | 178 | 0.9888 | 178 | 0.7991 | 0.5235 |
| layout:prose | 97 | 0.9691 | 97 | 0.7672 | 0.3819 |
| po_placement:subject_only | 121 | 0.9752 | 121 | 0.6630 | 0.2282 |
| po_placement:body_only | 141 | 0.9787 | 141 | 0.7561 | 0.2141 |
